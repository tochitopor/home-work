...
public class CollectionsTest {
     ...
     *
     * Вопрос.
     * Какую коллекцию из реализаций интерфейса Collections  вы предпочтете для текущего хранения и использования списка студентов?
     *
     ...
     *
     * Вопрос.
     * Какую коллекцию из реализаций интерфейса Collections  вы предпочтете использовать для хранения монет в боксе.
     *
     ...
     *
     * Вопрос.
     * Какую коллекцию из реализаций интерфейса Collections вы предпочтете использовать для хранения книг.
     *
